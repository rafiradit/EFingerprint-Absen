...
//************************************************************************
String postData ; // array ke website
String link = "http://YourComputerIP/biometricattendance/getdata.php"; //url get data file getdata
int FingerID = 0;     // Fingerprint ID asal sensor
uint8_t id;
void setup() {
